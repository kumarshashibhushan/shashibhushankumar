...
* Fix SWA create function for node model v4 by @ejizba in [#3721](https://github.com/Microsoft/vscode-azurefunctions/blob/main/[#3721](https:/github.com/microsoft/vscode-azurefunctions/pull/3721))
